...
twttr.events.bind('tweet', function(event) {
   ...
   window.location = "http://advancedcontent.trailerparkinteractive.com/tmnt"
...
window.ChooseView = Backbone.View.extend({
	...
	facebookTurtle: function(evt) {
		...
		TMNT.postFB('http://advancedcontent.trailerparkinteractive.com/tmnt/m1t','Mission Accomplished! I’ve joined TMNT at Comic-Con. The Foot Clan stinks!', 'http://advancedcontent.trailerparkinteractive.com/tmnt/images/facebookshare/turtleMission1.jpg', 'I’ve joined the Ninja Turtles in the battle for Comic-Con', cb);
	},
	facebookFoot: function(evt) {
		...
		//postFB: function(link, desc, pic, name, cb)
		TMNT.postFB('http://advancedcontent.trailerparkinteractive.com/tmnt/m1f','Hail Shredder! I’m on the path to power for I have joined the Foot Clan against the TMNT at Comic-Con. ', 'http://advancedcontent.trailerparkinteractive.com/tmnt/images/facebookshare/footMission1.jpg', 'I’ve joined the Foot Clan in the battle for Comic-Con', cb);
	},
...
window.MissionDetailView = Backbone.View.extend({
	...
	facebook6 : function() {
		var model = this.collection.models[5],
			cb6 = function() { window.location = "http://advancedcontent.trailerparkinteractive.com/tmnt/#mission" };
		TMNT.postFB(model.get('link'), model.get('desc'), 'http://advancedcontent.trailerparkinteractive.com/tmnt/images/facebookshare/'+model.get('pic'), model.get('name'), cb6)
	},
...
var TMNT = {
	...
	postFB: function(link, desc, pic, name, cb) {
		...
		/*var obj = {
    		display     : 'touch',
			method      : 'feed',
			link        : link ||'http://advancedcontent.trailerparkinteractive.com/tmnt',
			picture     : pic,
